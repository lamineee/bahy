    ...
    const { data, error } = await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>Connectez-vous à votre dashboard pour voir les détails et prendre action.</p>
          
          <a href="https://bahy.io/dashboard/reviews" style="display: inline-block; background: #000; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; margin-top: 16px;">
            Voir les avis
          </a>
